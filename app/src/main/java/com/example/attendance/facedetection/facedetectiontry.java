package com.example.attendance.facedetection;
...
public class facedetectiontry extends AppCompatActivity {
    ...
    private boolean step2verification;
    GraphicOverlay graphicOverlay;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_facedetectiontry);
                ...
                .addOnSuccessListener(
                        new OnSuccessListener<List<FirebaseVisionFace>>() {
                            ...
                            public void onSuccess(List<FirebaseVisionFace> faces) {
                                ...
                                if (faces.size() == 0) {
                                    Toast.makeText(facedetectiontry.this, "Face not Found", Toast.LENGTH_SHORT).show();
                                    fragmentreplace("Key", "Face not found");
                                }

                                for (FirebaseVisionFace face : faces) {
                                    Toast.makeText(facedetectiontry.this, "reached", Toast.LENGTH_SHORT).show();
                                    ...
                                    if (right > 0 & step2verification) {
                                        Toast.makeText(facedetectiontry.this, "turned right", Toast.LENGTH_SHORT).show();
                                        finish();
                                    }
...
//                                    showoutput.setText(stringBuilder.toString());
                ...
                .addOnFailureListener(
                        new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                progressBar.setVisibility(View.GONE);
                                Toast.makeText(facedetectiontry.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
    }
    ...
    private void fragmentreplace(String key, String text) {
        ...
        Fragment frame = new task_face_fragement();
