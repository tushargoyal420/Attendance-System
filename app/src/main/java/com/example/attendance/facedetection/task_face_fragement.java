...
public class task_face_fragement extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_task_face_fragement, container, false);
        ...
        okbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (turnright) {
                    Intent intent = new Intent(getActivity(), facedetectiontry.class);
